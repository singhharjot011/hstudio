  ...
  return (
    <>
      <div className="flex flex-col overflow-hidden bg-gradient-to-tr from-transparent via-purple-50 to-indigo-50 px-5 pt-3 text-stone-900 md:px-20 md:pt-6">
        ...
        <div className="flex h-full w-full flex-col gap-12 md:flex-row md:justify-between lg:p-10">
          {/* 1 */}
          <div className="flex flex-col space-y-4 md:h-full md:w-1/3">
            <div className="group relative flex-grow rounded-xl bg-gradient-to-r from-rose-100 to-teal-100 shadow-lg">
              <div className="absolute bottom-0 flex h-1/3 w-full items-center rounded-b-xl bg-gradient-to-t from-stone-800/70 px-5 opacity-0 backdrop-blur-[2px] duration-300 group-hover:opacity-100">
                <span className="font-semibold text-white md:text-sm lg:text-base">
          ...
          {/* 2 */}
          <div className="flex flex-col space-y-4 md:h-full md:w-1/3">
            <div className="group relative flex-grow rounded-xl bg-gradient-to-l from-lime-50 via-gray-50 to-yellow-50 shadow-lg">
              <div className="absolute bottom-0 flex h-1/3 w-full items-center rounded-b-xl bg-gradient-to-t from-stone-800/70 px-5 opacity-0 backdrop-blur-[2px] duration-300 group-hover:opacity-100">
                <span className="font-semibold text-white md:text-xs lg:text-sm xl:text-base">
          ...
          {/* 3 */}
          <div className="flex flex-col space-y-4 md:h-full md:w-1/3">
            <div className="group relative flex-grow rounded-xl bg-gradient-to-l from-rose-200 via-yellow-50 to-orange-200 shadow-lg">
              <div className="absolute bottom-0 flex h-1/3 w-full items-center rounded-b-xl bg-gradient-to-t from-stone-800/70 px-5 opacity-0 backdrop-blur-[2px] duration-300 group-hover:opacity-100">
                <span className="font-semibold text-white md:text-sm lg:text-base">
